    ...
    "sections": [
        ...
        {"heading": "Where things stand, and what's left", "blocks": [
            {"type": "status", "items": [
                ...
                {"label": "verify-repro", "detail": "published, tested end to end against a real Konflux-built image."},
            ]},
        ...
        {"heading": "The work, linked directly", "blocks": [
            {"type": "links", "items": [
                ...
                {"title": "Add verify-reproducibility pipeline and task", "url": "https://github.com/konflux-ci/build-definitions/pull/3803", "status": "closed by me, superseded by verify-repro below"},
                {"title": "verify-repro: rebuild and compare from SLSA provenance", "url": "https://github.com/JamesOlaitan/verify-repro", "status": "published"},
            ]},
        ]},
    ],
}
